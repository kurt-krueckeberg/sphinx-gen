...
The 7 May 1687  marriage of Hans Weilandt to Anna Catharina Borman is on {ref}`image 19 <image19>` of the
Petzen "Verzeichnis der Getrauten und Gestorbenen 1641-1784".

```{figure} images/petzen-band1b-img19.png
...
```{div} doc-text
Hans Weilandt von Meinsen Anna Catharina Bormans [???] den 7 Mai copuliert
```

## Translation

```{div} doc-text
Hans Weiland of Meinsen Anna Catharina Bormans [???], married 7 May.
```
